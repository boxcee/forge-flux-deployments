...
## [1.3.0](https://github.com/boxcee/forge-flux-deployments/compare/forge-flux-deployments-v1.2.0...forge-flux-deployments-v1.3.0) (2026-06-06)
...
* add CI workflow, Renovate config, and unit tests for shared.js ([#25](https://github.com/boxcee/forge-flux-deployments/issues/25)) ([#30](https://github.com/boxcee/forge-flux-deployments/issues/30)) ([98cc06a](https://github.com/boxcee/forge-flux-deployments/commit/98cc06a76f4b1beaab45ea68fbf9e93ba24e8a0a))
* add FORGE_USAGE_ANALYTICS env var to unblock non-interactive deploy ([4b61ba5](https://github.com/boxcee/forge-flux-deployments/commit/4b61ba5556d294dd3785e3fb75fdd0d6ccdad7ca))
* add FORGE_USAGE_ANALYTICS to unblock non-interactive deploy ([#32](https://github.com/boxcee/forge-flux-deployments/issues/32)) ([4b61ba5](https://github.com/boxcee/forge-flux-deployments/commit/4b61ba5556d294dd3785e3fb75fdd0d6ccdad7ca))
* **ci:** run forge settings set usage-analytics before non-interactive deploy ([d22b1cb](https://github.com/boxcee/forge-flux-deployments/commit/d22b1cbebc44f285ea494dbc877b7cba0a18c00a))
* correct deterministicId comment to reflect unsigned 32-bit range ([0a8801d](https://github.com/boxcee/forge-flux-deployments/commit/0a8801d0635134e9f982091100414973dc934c8a)), closes [#7](https://github.com/boxcee/forge-flux-deployments/issues/7)
* correct deterministicId comment to reflect unsigned 32-bit range ([#7](https://github.com/boxcee/forge-flux-deployments/issues/7)) ([#16](https://github.com/boxcee/forge-flux-deployments/issues/16)) ([0a8801d](https://github.com/boxcee/forge-flux-deployments/commit/0a8801d0635134e9f982091100414973dc934c8a))
* **deps:** update atlassian forge packages to v7 ([#40](https://github.com/boxcee/forge-flux-deployments/issues/40)) ([0924438](https://github.com/boxcee/forge-flux-deployments/commit/0924438af8ad1c75c115bd9351dc401f73aae50d))
* **deps:** update dependency react to v19 ([#42](https://github.com/boxcee/forge-flux-deployments/issues/42)) ([1bf9992](https://github.com/boxcee/forge-flux-deployments/commit/1bf99927d364ce4d3d4a8a1a572410bf59ca1915))
...
* migrate Renovate config to address config migration warning ([a020cf4](https://github.com/boxcee/forge-flux-deployments/commit/a020cf43b43ee64695d037ab1bcb004d1e1bd58f)), closes [#29](https://github.com/boxcee/forge-flux-deployments/issues/29)
* migrate Renovate config to address config migration warning ([#29](https://github.com/boxcee/forge-flux-deployments/issues/29)) ([#48](https://github.com/boxcee/forge-flux-deployments/issues/48)) ([a020cf4](https://github.com/boxcee/forge-flux-deployments/commit/a020cf43b43ee64695d037ab1bcb004d1e1bd58f))
...
* remove redundant try/catch wrapping logEvent calls ([#2](https://github.com/boxcee/forge-flux-deployments/issues/2)) ([#23](https://github.com/boxcee/forge-flux-deployments/issues/23)) ([f388414](https://github.com/boxcee/forge-flux-deployments/commit/f388414c9031324fd795299f4a901ab7a299bd88))
* remove redundant try/catch wrapping logEvent calls in index.js ([f388414](https://github.com/boxcee/forge-flux-deployments/commit/f388414c9031324fd795299f4a901ab7a299bd88)), closes [#2](https://github.com/boxcee/forge-flux-deployments/issues/2)
* replace defaultLabels with labels in renovate.json ([#53](https://github.com/boxcee/forge-flux-deployments/issues/53)) ([27c9b8e](https://github.com/boxcee/forge-flux-deployments/commit/27c9b8ef2c38d5cce6ae6d217c1aacf0f7c4de78))
* resolve admin page crash on first load (out is not a constructor) ([#33](https://github.com/boxcee/forge-flux-deployments/issues/33)) ([e298428](https://github.com/boxcee/forge-flux-deployments/commit/e2984281ed94b728c35151eb9cbd32504a4e9c29))
* resolver crash, CI deploy, and manifest lint errors ([#34](https://github.com/boxcee/forge-flux-deployments/issues/34)) ([3a2a3a0](https://github.com/boxcee/forge-flux-deployments/commit/3a2a3a0d4f71f1027fad12a12fc878a4df6dea7d))
* use consistent return shape in validateString ([#3](https://github.com/boxcee/forge-flux-deployments/issues/3)) ([#21](https://github.com/boxcee/forge-flux-deployments/issues/21)) ([020ceae](https://github.com/boxcee/forge-flux-deployments/commit/020ceaefbe58653cea6c9b10cde650574e4f7418))
* use consistent return shape in validateString (Closes [#3](https://github.com/boxcee/forge-flux-deployments/issues/3)) ([020ceae](https://github.com/boxcee/forge-flux-deployments/commit/020ceaefbe58653cea6c9b10cde650574e4f7418))
* use truthy check for configured status in getConfigStatus ([#4](https://github.com/boxcee/forge-flux-deployments/issues/4)) ([#11](https://github.com/boxcee/forge-flux-deployments/issues/11)) ([92d980f](https://github.com/boxcee/forge-flux-deployments/commit/92d980fc14687015f4a819f6c0574535b0999afd))
