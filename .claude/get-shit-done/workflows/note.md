...
- **Global scope**: `/Users/moritzschmitz-oviva/workspaces/forge-flux-deployments/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/moritzschmitz-oviva/workspaces/forge-flux-deployments/.claude/notes/`)
...
2. Glob `/Users/moritzschmitz-oviva/workspaces/forge-flux-deployments/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/moritzschmitz-oviva/workspaces/forge-flux-deployments/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/moritzschmitz-oviva/workspaces/forge-flux-deployments/.claude/notes/` — works in any directory
